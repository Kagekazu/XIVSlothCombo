...
namespace XIVSlothCombo.Combos
{
    ...
    public enum CustomComboPreset
    {
        ...
        */
        ...
        [CustomComboInfo("AoE DPS Feature", "Adds various options to Dyskrasia I & II", SGE.JobID, 200, "", "")]
        SGE_AoE_DPS = 14009,

        [ParentCombo(SGE_AoE_DPS)]
        [CustomComboInfo("Phlegma Option", "Uses Phlegma if available.", SGE.JobID, 210, "", "")]
        SGE_AoE_DPS_Phlegma = 14010,

        [ParentCombo(SGE_AoE_DPS)]
        [CustomComboInfo("Toxikon Option", "Use Toxikon if available.", SGE.JobID, 220, "", "")]
